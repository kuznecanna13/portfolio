...
skills = [ (_,) for _ in (['Python', 'SQL', 'API', 'Telegram', 'HTML', 'CSS', 'JS'])]
statuses = [ (_,) for _ in (['Проектирование', 'В разработке', 'Обновлён', 'Разработан', 'Завершен'])]
...
if __name__ == '__main__':
    ...
    manager.insert_skill(1111, 'bot', 'Python')
