...
/new_project - добавление нового проекта и данных о нём 💡
/projects - посмотреть все свои проекты 👀
/update_projects - обновить данные о своем проекте 💻
/skills - указать используемые навыки  💪
/delete - удалить свой проект ❌

/info - посмотреть команды ❓

Чтобы посмотреть информацию о своем проекте, отправь его название в чат! ✍️""")
...
def name_project(message):
    ...
    data = [user_id, name]
    bot.send_message(message.chat.id, "Вставьте ссылку на проект")
